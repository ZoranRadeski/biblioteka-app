...
namespace BibliotekaAPP.Controllers
{
    public class KorisniciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KorisnikID,Ime,Prezime,BrojTelefona")] Korisnici korisnici)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KorisnikID,Ime,Prezime,BrojTelefona")] Korisnici korisnici)
        {
            if (ModelState.IsValid)
            {
